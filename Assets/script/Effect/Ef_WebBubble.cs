...
public class Ef_WebBubble : MonoBehaviour {
	public SpriteRenderer Prefab_Bubble;
	...
	IEnumerator _Coro_GenerateBubble()
	{
		...
		{
			SpriteRenderer sprBubble = Instantiate(Prefab_Bubble) as SpriteRenderer;
	...
	IEnumerator _Coro_BubbleScaleUp(SpriteRenderer spr)
	{
		//设置颜色
		Color c = spr.color;
		c.a = AlphaStart;
