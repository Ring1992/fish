...
public class Ef_WebBoom : MonoBehaviour
{
	...
	void Start()
	{
		...
		mShakeDirects = new Vector3[]{
						...
						,new Vector3(0.01F,-0.012F,0F)
						,new Vector3(0.012F,0.01F,0F)
						,new Vector3(-0.012F,-0.008F,0F)
				};
		mSprWeb = Instantiate(Prefab_GoSpriteWeb).GetComponent<SpriteRenderer>();
		ColorInitialize = mSprWeb.color;
